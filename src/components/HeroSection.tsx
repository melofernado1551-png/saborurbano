...
const HeroSection = () => {
  return (
    <section className="relative pt-8 md:pt-12 pb-0 overflow-hidden min-h-[280px]">
      <CityScapeBackground />

      <div className="container mx-auto px-4 relative z-10">
        <div className="flex items-end justify-between gap-8">
          <div className="text-center md:text-left max-w-2xl flex-1 pb-8">
          ...
          <div className="hidden md:block flex-shrink-0 animate-fade-in self-end" style={{ animationDelay: "300ms" }}>
            <img
              src={heroCharacter}
              alt="Entregador Sabor Urbano"
              className="w-44 lg:w-56 h-auto drop-shadow-lg translate-y-[2px]"
            />
          </div>
        </div>
      </div>
